...
{
    public class GetProductFeatureQueryHandler : IRequestHandler<GetProductFeatureQuery, List<ProductFeatureViewModel>>
    {
        ...
        public async Task<List<ProductFeatureViewModel>> GetProductFeature(int id)
        {
            try
            {
                ...
                using (var connection = new SqlConnection(Utils.GetConnectionString()))
                {
                    ...
                    IEnumerable<dynamic> result = await connection.QueryAsync("ListProductFeature",                        
        ...
        public async Task<List<ProductFeatureViewModel>> Handle(GetProductFeatureQuery request, CancellationToken cancellationToken)
        {
