...
{
    public class ProductVariationBatch : BatchObject<ProductVariation> { }

    [DataContract]
    public class ProductVariation : JsonObject
    {
        public static string Endpoint { get { return "products/${productId}/variations"; } }
